...
//Code Here
let postTaxPrices = prices.map(newPrice => {
  newPrice = prices * 1.07;
  return newPrice;
})
...
//Code Here
let totalPopulation = populations.reduce((total, p) => total + p)
...
let bobsTotal = bobsPurchases.reduce((sum, p) => sum + p.price, 0);
